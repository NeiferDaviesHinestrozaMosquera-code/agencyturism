        ...
        <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <div className="flex space-x-4">
                {['Facebook', 'Instagram', 'Twitter', 'YouTube'].map((social) => (
                  <button
                    key={social}
                    className="px-4 py-2 border border-gray-300 rounded-lg hover:bg-yellow-50 hover:border-yellow-500 transition-colors"
                  >
                    {social}
                  </button>
                ))}
          ...
          <div className="bg-white p-8 rounded-2xl shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button 
                type="submit"
                className="w-full bg-yellow-500 hover:bg-yellow-600 text-black font-semibold px-6 py-3 rounded-lg transition-all duration-300 flex items-center justify-center gap-2"
              >
